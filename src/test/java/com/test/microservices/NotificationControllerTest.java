...
public class NotificationControllerTest {
    ...
    public void testSaveNotification() throws JsonProcessingException {
        // Arrange
        doNothing().when(notificationService).saveNotification(any(Notifications.class));
    ...
    public void testGetActiveNotifications() throws JsonProcessingException {
        ...
        // Act
        ResponseEntity<List<Notifications>> response = notificationController.getActiveNotifications();
